...
typedef enum {
    ImageFlickDirectionNone,
    ImageFlickDirectionRight,
    ImageFlickDirectionLeft
} JTSImageFlickDiractionFlags;
...
@property (assign, nonatomic) JTSImageFlickDiractionFlags flickDiraction;
